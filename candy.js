...
var columns = 9;
var score = 0;
var turns = 20; // Set the number of allowed turns
var currTile;
var otherTile;

window.onload = function () {
    startGame();
    //1/10th of a second candyCrush
...
function dragEnd() {
    ...
    if (isAdjacent) {
        ...
        if (validMove) {
            ...
            document.getElementById("turns").innerText = turns; // Update turn display
            if (turns === 0) {
